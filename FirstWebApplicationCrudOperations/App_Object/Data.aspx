...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowCommand="Row_Command" OnRowDeleting="Row_Deleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
